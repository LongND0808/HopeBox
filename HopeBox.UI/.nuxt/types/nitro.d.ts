...
declare global {
  const __buildAssetsURL: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('E:/EXE/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useStorage']
