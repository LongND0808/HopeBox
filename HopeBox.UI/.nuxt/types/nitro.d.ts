...
declare global {
  const __buildAssetsURL: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('D:/Project/HopeBox/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useStorage']
