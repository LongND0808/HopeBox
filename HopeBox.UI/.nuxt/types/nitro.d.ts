...
declare global {
  const __buildAssetsURL: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('C:/Work/HopeBox/HopeBox.UI/node_modules/nitropack/dist/runtime')['useStorage']
