        ...
        <div class="col-12">
            ...
            <div class="filter-controls">
              <div class="row">
                <div class="col-md-3 mb-3">
                  ...
                  <input v-model="filters.title" type="text" class="form-control" placeholder="Nhập tiêu đề bài viết..."
              ...
              <div class="row">
                <div class="col-md-12 mb-3 d-flex align-items-end gap-2">
                  ...
                  <button class="btn btn-reset" @click="handleReset" :disabled="loading">Reset
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="blog-content-column" v-else-if="blogsData && blogsData.length > 0">
            <div class="blog-content-area post-items-style2">
              <div class="post-item row" v-for="blog in blogsData" :key="blog.id">
                <div class="col-md-4 thumb">
                  <nuxt-link :to="`/blog-details?id=${blog.id}`">
                    <img :src="blog.imageUrl || '/images/placeholder.jpg'" style="width: 100% !important; height:  100% !important" :alt="blog.title" @error="handleImageError" class="img-fluid">
                  </nuxt-link>
                  <div class="meta-date">
                  ...
                  <div class="inner-content">
                    <div class="meta">
                      ...
                      <span class="post-author">
                        ...
                        Đăng bởi: {{ blog.creatorName || 'Ẩn danh' }}
                      </span>
                    </div>
                    <h4 class="title">
                    ...
                    <div class="blog-stats mb-3">
                      ...
                      <span class="stat-item">
                        <i class="fa fa-clock"></i> {{ blog.readingTime || 0 }} phút
                      </span>
                    </div>
              ...
              <div class="pagination-area pt-0 pb-0" v-if="totalPages > 1">
                <nav>
                  <ul class="page-numbers">
                    <li>
                      <a class="page-number prev" href="#" @click.prevent="goToPage(pagination.pageIndex - 1)"
                    ...
                    <li v-for="page in visiblePages" :key="page">
                      <a class="page-number" href="#" @click.prevent="goToPage(page)"
                    ...
                    <li>
                      <a class="page-number next" href="#" @click.prevent="goToPage(pagination.pageIndex + 1)"
