    ...
    public partial class initdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
<<<<<<<< HEAD:HopeBox.Infrastructure/Migrations/20250612155734_init-database.cs
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
...
>>>>>>>> master_merge:HopeBox.Infrastructure/Migrations/20250627031038_init-database.cs
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Challenge = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: false),
                    ...
                    SummaryImage = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfirmCode = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
...
>>>>>>>> master_merge:HopeBox.Infrastructure/Migrations/20250627031038_init-database.cs
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareCaption = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
...
<<<<<<<< HEAD:HopeBox.Infrastructure/Migrations/20250612155734_init-database.cs
                    ...
                    TradingCode = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false)
========
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
...
>>>>>>>> master_merge:HopeBox.Infrastructure/Migrations/20250627031038_init-database.cs
            ...
            migrationBuilder.CreateTable(
                name: "DonationReliefPackages",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DonationId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReliefPackageId = table.Column<Guid>(type: "uuid", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonationReliefPackages", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReliefPackageId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReliefItemId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonationReliefPackages_DonationId",
                table: "DonationReliefPackages",
                column: "DonationId");

            migrationBuilder.CreateIndex(
                name: "IX_DonationReliefPackages_ReliefPackageId",
                table: "DonationReliefPackages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReliefPackageItems_ReliefItemId",
                table: "ReliefPackageItems",
                column: "ReliefItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ReliefPackageItems_ReliefPackageId",
                table: "ReliefPackageItems",
                column: "ReliefPackageId");
